...
| **S0–S13** Native Swift engine | **S4b done** | Zone density/grade + CMY at autos-off. Next: S5 autos + metering. See §14 |

**Resume here:** Native engine **S5** (Auto Density / Auto Grade + metering remap). S4b zone/CMY are in at autos-off. See [docs/PERFORMANCE.md](docs/PERFORMANCE.md) for leftover M12 manual benches.
...
5. **Native engine S5:** Auto Density / Auto Grade + metering remap. S4b zone/CMY are in — see §14.
