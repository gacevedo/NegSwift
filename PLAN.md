...
| **S0–S13** Native Swift engine | **S10a done** | Heal uv_grid mapping + preview inpaint. Next: S10b optical dust. See §14 |

**Resume here:** Native engine **S10b** (optical dust toggle). S10a heal is in. See [docs/PERFORMANCE.md](docs/PERFORMANCE.md) for leftover M12 manual benches.
...
5. **Native engine S10b:** optical dust toggle vs Python. S10a heal is in — see §14.
