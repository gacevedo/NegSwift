...
| **S0–S13** Native Swift engine | **S4a done** | H&D + cast + BPC + OETF. Autos/Lab still off. Next: S4b zone/CMY. See §14 |

**Resume here:** Native engine **S4b** (zone density/grade + CMY at autos-off). S4a print curve + working OETF are in. See [docs/PERFORMANCE.md](docs/PERFORMANCE.md) for leftover M12 manual benches.
...
5. **Native engine S4b:** Zone density/grade + CMY at the S4 pin. S4a print + OETF are in — see §14.
